...
import static Interfaces.Login_Activity.dataarray1;
...
public class Requisition extends javax.swing.JFrame {
    ...
    public Requisition() {
        initComponents();
         ...
         Requisition.requestionIdDataarray1 =   procurement.getRequestionIds();
        System.out.println(requestionIdDataarray1);
       JSONArray jsonArr = new JSONArray(requestionIdDataarray1); 
         ...
         Requisition.getSuppliernames = procurement.getSuppliernames();
           System.out.println(getSuppliernames);
       JSONArray jsonArr1 = new JSONArray(getSuppliernames); 
      ...
      public static  String requestionIdDataarray1 ="";
      public static  String  getitemsbyreqId = "";
      public static  String  getSuppliernames = "";
      public static  String  getplaceorderresponse = "";
    ...
    private void approverRequisitionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_approverRequisitionActionPerformed
       ...
       String requestidcomboboxvalue = requestionIdComboBox.getSelectedItem().toString();
        ...
        // System.out.println(Requireddate.getDate().toString());
		...
		JSONObject jo = new JSONObject();  // working JSONObject
            ...
            int column = 1;
                for (int j = 0; j  < row; j++) {
                                ...
                                jo.put("itemDescription", reqIdItems.getValueAt(j, column));
                                jo.put("username","Guest");
                                jo.put("itemPrice", reqIdItems.getValueAt(j, column+2));
                                jo.put("itemQty",reqIdItems.getValueAt(j, column+1) );
                                 System.out.println(reqIdItems.getValueAt(j, column));
                                 ja.put(jo);
                  }
    ...
    private void searchbtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchbtn1ActionPerformed
      ...
      String searchbtnvalue = requestionIdComboBox.getSelectedItem().toString();
       ...
       Requisition.getitemsbyreqId   =   procurement.getItemByReqNumbers(searchbtnvalue);
       JSONArray jsonArr = new JSONArray(getitemsbyreqId);
    ...
    private void placeorderbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_placeorderbtnActionPerformed
        // TODO add your handling code here:
         ...
         Requisition.getplaceorderresponse =  procurement.placePurchaseOrder(searchbtnvalue,supplierName,addressLine1,addressLine2,other,requiredDate);
        
         JSONObject object =  new JSONObject(getplaceorderresponse);
